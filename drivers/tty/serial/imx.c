...
struct imx_port {
    ...
    /* RS485 fields */
    int is_rs485;//add by zhengsh, be used to control tx and rx.
    int rs485_flow_ctrl_gpio;//add by zhengsh, be used to control tx and rx.
...
static int serial_imx_probe(struct platform_device *pdev)
{
    ...
    if ( pdata && pdata->is_rs485 )
    {
        sport->is_rs485         = 1;
        sport->rs485_flow_ctrl_gpio = pdata->rs485_flow_ctrl_gpio;
