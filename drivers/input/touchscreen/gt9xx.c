...
static int goodix_ts_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
   ...
   // gtp_rst_gpio = good_ts_pdev->goood_ts_rst_pin;
	//gtp_int_gpio = good_ts_pdev->good_ts_irq_pin;
#endif
