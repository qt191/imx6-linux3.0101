...
#include "board-mx6q_qiyang_dev.h"
#include "board-mx6dl_qiyang_dev.h"

#include <linux/misc/watchdog.h>


#define BUZZER_PIN      IMX_GPIO_NR(1, 2)

#define ENABLE_PIN      IMX_GPIO_NR(5, 20)
#define FEEDDOG_PIN    IMX_GPIO_NR(5, 18)

#define QY_IMX6S_SD3_CD          IMX_GPIO_NR(7 , 0)
#define QY_IMX6S_SD3_WP          IMX_GPIO_NR(7 , 1)
#define QY_IMX6S_OTG_PWR         IMX_GPIO_NR(1 , 1)


#define QY_IMX6S_PCIE_DIS        IMX_GPIO_NR(5 , 19)
#define QY_IMX6S_PCIE_RST        IMX_GPIO_NR(5 , 21)
//#define QY_IMX6S_HUB_RST         IMX_GPIO_NR(1 , 10)
#define QY_IMX6S_NET_PHY_RST     IMX_GPIO_NR(7 , 8)
...
#define QY_IMX6S_MIPICSI_RST    IMX_GPIO_NR(4 , 16)
#define QY_IMX6S_MIPICSI_PWN    IMX_GPIO_NR(4 , 17)
...
static inline void mx6q_qy_imx6s_init_uart(void)
{
    switch(rs485_count)
    {
        ...
        case 1:
        	imx6q_add_imx_uart(4, NULL);
        	imx6q_add_imx_uart(3, &imx_uart_data[0]);
        break;
        
        case 2:
        	imx6q_add_imx_uart(4, &imx_uart_data[1]);
        	imx6q_add_imx_uart(3, &imx_uart_data[0]);
        break;
    }
...
static struct i2c_board_info mxc_i2c2_board_info[] __initdata = {
	{
		//	I2C_BOARD_INFO("ft5x0x_ts", 0x38),
		   I2C_BOARD_INFO("icn85xx_ts", 0x40),
	},
};
 ...
 */
MACHINE_START(MX6Q_QIYANG_DEV, "Freescale i.MX 6Quad/DualLite/Solo IAC-IMX6-CM-V2.03 Board")
